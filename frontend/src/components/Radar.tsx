...
/**
 * WebGL radar-sweep background, from reactbits.dev
 * (https://reactbits.dev/backgrounds/radar), used on `LandingPage`.
 * Ported as-is (shader + render loop unchanged) and typed for this repo's
 * strict TS config. Requires the `ogl` package.
 */
...
export function Radar({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // No WebGL context (headless test runners, software-disabled WebGL) —
